// ====== トップページ：クリックで個別ページへ遷移 ======

// 神社7種類の「サムネイル写真」と「リンク先」
const items = [
  {
    title: "愛宕神社",
    src: "atago/1.jpg",
...
// ===== トップページでは音のhover再生は無効 =====
// → あえて何も書かない（個別ページで処理する）
  ...
  /* ==============================
     10) Console Guide
  ============================== */
  console.info(`画像/音声を差し替える: ITEMS を変更\n例: { src:'img/a.jpg', audio:'audio/a1.mp3', label:'神社名' }\n?cols=3 で初期列変更可`);
